    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{ route('edit.general') }}"
                        data-i18n="nav.templates.vert.classic_menu">{{ __('admin/sidebar.general settings') }}</a>
                    </li>

                    <li><a class="menu-item" href="{{ route('edit.social') }}"
                        data-i18n="nav.templates.vert.classic_menu">{{ __('admin/sidebar.social settings') }}</a>
                    </li>
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{ __('admin/sidebar.delivery means') }}</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{ route('edit.shipping.method','inner') }}">{{ __('admin/sidebar.inner delivery') }}</a>
                            </li>
                    ...
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{ __('admin/sidebar.home page slider') }}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ route('admin.create.slider.image') }}"
                                   data-i18n="nav.templates.vert.classic_menu">{{ __('admin/sidebar.slider image') }}</a>
                            </li>
                        </ul>
                    </li>
                </ul>
